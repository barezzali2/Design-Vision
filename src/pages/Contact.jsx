    ...
    <div>
      ...
      <div className="px-6 md:px-20 py-10 text-center mx-7">
        ...
        <p className="text-gray-500 max-w-2xl mx-auto leading-relaxed mb-10">
          We’d love to hear from you. Whether you’re interested in working
          together, have a question, or simply want to say hello — feel free
          to reach out using the details below.
        </p>
